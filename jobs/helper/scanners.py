...
from jobs.helper.base import RiskLevel, _max_risk, _scan_patterns
from jobs.helper.pii import _PIIScanner
from jobs.helper.injection import INJECTION_COMPILED
from jobs.helper.jailbreak import JAILBREAK_COMPILED
...
def scan(
    ...
    jailbreak = _scan_patterns(prompt, JAILBREAK_COMPILED,  "jailbreak")
